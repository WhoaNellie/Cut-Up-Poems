...
var app = (function () {
    ...
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(path, file, 137, 4, 5360);
    			attr_dev(clipPath, "id", clipPath_id_value = `paper${/*i*/ ctx[10]}`);
    			add_location(clipPath, file, 142, 4, 5459);
    			...
    			add_location(text_1, file, 145, 4, 5515);
    			attr_dev(svg, "class", "svelte-jhpy9z");
    			add_location(svg, file, 130, 0, 5216);
    		},
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(130:0) {#each words as word, i}",
    		ctx
    	});
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console_1.warn(`<Words> was created with unknown prop '${key}'`);
    	});
    ...
    class Words extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*words*/ ctx[0] === undefined && !("words" in props)) {
    			console_1.warn("<Words> was created without expected prop 'words'");
    		}
    	}
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$1, 30, 2, 915);
    			add_location(p, file$1, 31, 2, 950);
    			attr_dev(textarea, "id", "words");
    			attr_dev(textarea, "cols", "30");
    			attr_dev(textarea, "rows", "10");
    			attr_dev(textarea, "class", "svelte-1e22w9p");
    			add_location(textarea, file$1, 32, 2, 1090);
    			attr_dev(button, "id", "submitWords");
    			attr_dev(button, "class", "svelte-1e22w9p");
    			add_location(button, file$1, 33, 2, 1168);
    			attr_dev(div, "id", "chooseWords");
    			attr_dev(div, "class", "svelte-1e22w9p");
    			add_location(div, file$1, 29, 1, 889);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(button, "click", /*getWords*/ ctx[3], false, false, false)
    				];
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$1, 27, 0, 864);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
...
And there you are—an infinitely original author of charming sensibility, even though unappreciated by the vulgar herd.`;
    	...
    	return [words, wordsStr, visible, getWords, textarea_input_handler];
    }
    ...
    var App$1 = App
      = ({ url: (document.currentScript && document.currentScript.src || new URL('bundle.js', document.baseURI).href) }) && undefined
        ? applyHmr$1({
            ...
            Component: App,
            ProxyAdapter: ProxyAdapterDom,
            compileData: {"vars":[{"name":"Words","export_name":null,"injected":false,"module":false,"mutated":false,"reassigned":false,"referenced":true,"writable":false,"referenced_from_script":false},{"name":"words","export_name":null,"injected":false,"module":false,"mutated":false,"reassigned":true,"referenced":true,"writable":true,"referenced_from_script":true},{"name":"wordsStr","export_name":null,"injected":false,"module":false,"mutated":false,"reassigned":true,"referenced":true,"writable":true,"referenced_from_script":true},{"name":"visible","export_name":null,"injected":false,"module":false,"mutated":false,"reassigned":true,"referenced":true,"writable":true,"referenced_from_script":true},{"name":"getWords","export_name":null,"injected":false,"module":false,"mutated":false,"reassigned":false,"referenced":true,"writable":false,"referenced_from_script":false}],"accessors":false},
